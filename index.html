    ...
    <ul>
      ...
      <div class="menu">
        <li>
          <a href="#">Categoria ▾ </a>
          <ul class="micro_menu">
            <li><a href="Paginas_Error/AccionE.html">Acción</a></li>
            <li><a href="Paginas_Error/2De.html">2D</a></li>
            <li><a href="Paginas_Error/terrore.html">Terror</a></li>
            <li><a href="Paginas_Error/mundolibree.html">Mundo libre</a></li>
          </ul>
        </li>
        <li><a href="">Sobre Nosotros</a></li>
        <li><a href="Paginas/iniciosesion.php" class="name">Iniciar Sesión</a></li>
      </div>
    </ul>
    <header>
      <!-- animacion -->
      ...
      <selection class="galeria-fotos">
        ...
        <figure class="ig ig--img1"></figure>
        <figure class="ig ig--img2"></figure>
        <figure class="ig ig--img3"></figure>
        <figure class="ig ig--img4"></figure>
      ...
      <div class="cuadro grid-container">
        <div class="contenedor">
          <div class="informacion" id="">
            <img class="logos" src="logito.png" alt="" />
            <p>
